	...
	<c:when test="${operazione == 'edit'}">
		...
		<table border="0" cellpadding="0" width="600px">
			...
			<tr><td><label for="surname">Cognome:</label></td>
				<td><input maxlength="15" type="text" size="15" name="surname" value="${surname}"/></td></tr>
			<tr><td><label for="mail">E-mail:</label></td>
				<td><input maxlength="20" type="text" size="15" name="mail" value='${mail}'/></td></tr>
			<tr><td><label for="web">Web:</label></td>
				<td ><input maxlength="20" type="text" size="15" name="web" value='${web}'/></td></tr>
			<tr><td><label for="city">Citta:</label></td>
				...
				<td ><input maxlength="15" type="text" size="15" name="state" value='${state}'/></td></tr>
			...
			<tr><td><label for="cell">Cellulare:</label></td>
				...
				<td><input maxlength="11" type="text" size="15" name="fax" value='${fax}'/></td></tr>
